...
export default function PricingPage() {
  const tiers = [
    ...
    },
    {
      ...
      features: [
        "Véhicules illimités",
        "Validation photo HD avancée",
        "Dashboard multi-flottes",
  ...
  const upsells = [
    ...
    { name: "Nettoyage extérieur", price: "+15€", icon: Waves },
  ]

  return (
    <div className="flex flex-col w-full">
      <section id="hero" className="pt-24 pb-12 lg:pt-32 lg:pb-20 bg-[#0A2E1A] text-white">
        ...
        <div className="container mx-auto px-6">
            ...
            {tiers.map((tier, i) => (
              <Card key={i} className={`flex flex-col p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl border-none ${tier.highlight ? 'bg-white shadow-xl ring-2 ring-primary' : 'bg-white shadow-lg'}`}>
                <CardHeader className="p-0 mb-4">
                  ...
                  <CardDescription className="mt-1 text-sm leading-relaxed min-h-[40px] text-slate-500 font-medium">
                    {tier.description}
                  </CardDescription>
                </CardHeader>
                ...
                <CardFooter className="pt-12 p-0">
          ...
          <div className="mt-24 max-w-5xl mx-auto">
            <div className="text-center space-y-4 mb-12">
              <h2 className="text-3xl font-bold">Payez selon vos besoin.</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-[3rem] overflow-hidden border border-border shadow-2xl bg-white">
              <div className="p-10 lg:p-14 space-y-8 bg-slate-50">
              ...
              <div className="p-10 lg:p-14 space-y-8 bg-white border-t lg:border-t-0 lg:border-l border-border relative">
